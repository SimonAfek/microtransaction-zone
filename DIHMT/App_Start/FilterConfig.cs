...
namespace DIHMT
{
    public class FilterConfig
    {
        public static void RegisterGlobalFilters(GlobalFilterCollection filters)
        {
            ...
            filters.Add(new CspImgSrcAttribute { Self = true, CustomSources = "www.giantbomb.com www.paypalobjects.com syndication.twitter.com pbs.twimg.com platform.twitter.com ton.twimg.com dummyimage.com data:" });
            ...
            filters.Add(new CspConnectSrcAttribute { Self = true, CustomSources = "www.paypal.com"});
