...
namespace DIHMT
{
    public class FilterConfig
    {
        public static void RegisterGlobalFilters(GlobalFilterCollection filters)
        {
            ...
            filters.Add(new CspImgSrcAttribute { Self = true, CustomSources = "https://www.giantbomb.com https://www.paypalobjects.com https://syndication.twitter.com https://pbs.twimg.com https://platform.twitter.com https://ton.twimg.com data:" });
